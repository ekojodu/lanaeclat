    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-tabs">
          ...
          <button className={mode === 'signup' ? 'active' : ''} onClick={() => { setMode('signup'); setError(''); setSuccess('') }}>Create Account</button>
        </div>
        ...
        <p className="auth-note">Access restricted to authorized studio admins only.</p>
      </div>
    </div>
  )
}
